...
Implement the approved `/goal`, customer-specific `SKILL.md`, and `DESIGN.md` using customer-owned or licensed content. Build semantic responsive pages, functional navigation and forms, honest error states, secure server boundaries, accessible interactions, reduced-motion behavior, and performant media.
...
Build only from the design-approved version in the private owner command center for the exact project ID. Preserve
...
deliver it. Customer visibility still requires separate delivery approval.
