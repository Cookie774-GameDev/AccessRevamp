...
A green local build is not a launch claim. See `docs/PRODUCT.md`, `docs/ARCHITECTURE.md`, `docs/PAYMENTS.md`, `docs/QUALITY.md`, and `docs/DEPLOYMENT.md` for the exact evidence gates.
