...
| 1 | Homepage Reveal | $50 one time | Human-reviewed report, one landing-page direction, desktop/mobile PNGs, one subtle AI-assisted motion poster ad, implementation priorities, and a 30-day growth plan. |
| 2 | Complete Website Revamp | $200 one time | Applicable Homepage Reveal work plus an agreed responsive implementation of up to five standard content pages, 15 Canva-built animated posters total, three business-card variations, two brochure variations, and a retest summary. |
