export const routeMetadata = Object.freeze({
  ...
  '/services': ['Services', 'Choose a focused reveal, a practical quick fix, or a cinematic scroll site.'],
  '/process': ['Process', 'See how AccessRevamp moves from public evidence to a human-reviewed direction.'],
  '/pricing': ['One-time pricing', 'Three clear AccessRevamp services with no recurring platform fee.'],
