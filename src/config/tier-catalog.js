...
export const TIERS = Object.freeze({
  ...
  complete_revamp: tier({
    ...
    summary: 'The applicable reveal work plus an agreed responsive implementation of up to seven individual pages.',
    listPriceCents: 20000,
    displayPrice: '$200',
    currency: 'USD',
    cadence: 'one-time',
    features: ['Every applicable $50 Homepage Reveal deliverable', 'Up to seven agreed individual pages', 'Responsive accessibility and performance work', 'Five Canva-built AI-assisted motion poster ads', 'Ten still poster variations', 'Three business card variations', 'Two brochure variations', 'Before/after evidence and one retest summary', 'Upgrade to the $250 Cinematic plan later for only $50'],
    valueGroups: [
      { label: 'Strategy', detail: 'Applicable Homepage Reveal findings and the agreed direction.' },
      { label: 'Website', detail: 'Up to seven responsive pages with accessibility and performance work.' },
